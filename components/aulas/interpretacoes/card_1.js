...
export default function Card_1() {
  return (
    <Container>
      <Card>
        <Title>Interpretação de Copenhague</Title>
        <TextContainer>
          <p>
            A física quântica não apenas descreve o comportamento das partículas
            subatômicas, mas também levanta profundas questões sobre a natureza
            da realidade.
          </p>
          <p>
          ...
          <p>
            Ou seja, ela vai contra os conceitos determinísticos de que destino
            e que o futuro do universo já foi escrito. É tudo aleatório e
            imprevisível!
          </p>
        </TextContainer>
      </Card>
