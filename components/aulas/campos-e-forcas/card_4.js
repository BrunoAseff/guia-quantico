...
export default function Card_4() {
  return (
    <Container>
      <Card>
        <Title>Força nuclear forte (Glúon)</Title>
        <TextContainer>
          <p>
          ...
          <p>
            ...
            glúons como pequenos "cola-tudo" que unem as partículas do núcleo
            com uma força inacreditável.
          </p>

          <p>
            Ao contrário da gravidade ou do magnetismo, a força nuclear forte é
            super forte, mas só age em distâncias muito curtas, como dentro de
            um núcleo atômico.
          </p>
          <p>
            Sem essa força, os núcleos dos átomos simplesmente se
            desintegrariam. Os glúons são, portanto, os heróis invisíveis que
            garantem que tudo ao nosso redor continue existindo!
          </p>
        </TextContainer>
      </Card>
    </Container>
