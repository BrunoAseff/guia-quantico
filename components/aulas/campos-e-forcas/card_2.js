...
export default function Card_2() {
  return (
    <Container>
      <Card>
        <Title>Forças fundamentais</Title>
        <TextContainer>
          <p>
            No universo, tudo é mantido junto e interage através de quatro
            forças fundamentais.
          </p>
          <p>
          ...
          <p>
            ...
            responsável por praticamente todas as interações do dia a dia, como
            a luz, a eletricidade e o magnetismo.
          </p>
          <p>
