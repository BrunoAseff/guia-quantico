...
export default function Card_3() {
  return (
    <Container>
      <Card>
        <Title>Simetrias quânticas</Title>
        <TextContainer>
          <p>
          ...
          <p>
            ...
            paridade (inversão espacial), simetria de tempo (reversão temporal)
            e simetria de carga (troca de partículas por antipartículas).
          </p>
          <p>
            Essas simetrias ajudam os físicos a entender e prever como as
            partículas se comportam e interagem, e são fundamentais para
            formular as leis da física.
          </p>
        </TextContainer>
      </Card>
    </Container>
